const STORAGE_KEY = "portfolio_command_center_public_demo_v1";
const ACCOUNT_VIEWS = {
...
const defaultState = {
  profile: {
    operatingBase: "Demo profile · Sample investor",
    northStar:
  ...
  holdings: [
    {
      ...
      note:
        "Demo taxable-account position with placeholder sizing and targets.",
    },
    {
      ticker: "COIN",
    ...
    },
    {
      ...
      note:
        "Demo digital-asset position with sample lot math removed.",
    },
    {
      ticker: "AMD",
      name: "AMD",
    ...
    },
    {
      ...
      note:
        "Demo high-beta infrastructure position with placeholder sizing.",
    },
    {
      ticker: "AMZN",
      name: "Amazon",
    ...
    },
    {
      ...
      note:
        "Demo AI software position with placeholder numbers.",
    },
    {
      ticker: "MU",
    ...
    },
    {
      ...
      note:
        "Demo retirement holding with placeholder balance and gain.",
    },
    {
      ticker: "SP500",
      ...
      note:
        "Demo retirement index holding with placeholder numbers.",
    },
    {
      ticker: "HON",
      name: "Honeywell",
      ...
      note:
        "Demo retirement equity holding with placeholder numbers.",
    },
  ],
  cashAccounts: [
    { name: "Brokerage Cash", type: "Investment", balance: 1250, account: "brokerage", note: "Demo cash balance for public sample data." },
  ],
  history: {
    labels: [
    ...
    brokerage: [11800, 12450, 13220, 12940, 14110, 15280, 16640, 18125],
    retirement: [16400, 17050, 17680, 18340, 19020, 19750, 20410, 21260],
    combined: [28200, 29500, 30900, 31280, 33130, 35030, 37050, 39385],
  },
  planning: {
    k401: {
      currentBalance: null,
